...
const PostItem = ({addLike, removeLike,deletePost, auth, post:{_id,
text,name,avatar,user,likes,comments,date
          ...
          <div>
            ...
            {!auth.loading && auth.user && (user === auth.user._id || user === auth.user.id) && (
